...
# -- BOOKING --#
raw_treatment.treat_booking_csv(
    config["raw"]["path_in"],
...
# -- SUBSCRIPTION --#
raw_treatment.treat_subscription_csv(
    config["raw"]["path_in"],
    config["raw"]["sub_file"],
    config["raw"]["path_out"],
    config["raw"]["sub_file"],
...
# -- BOOKING --#
stg_treatment.treat_stg_booking(
    config["staging"]["path_in_out"],
...
months_since_first_subscription.get_months_passed_since_first_sub(
...
months_active_canceled.get_months_per_status(
    config["sandbox"]["path_in"],
    config["sandbox"]["path_out"],
    config["sandbox"]["sub_file"],
...
months_since_last_status_change.get_months_status_change(
    config["sandbox"]["path_in"],
    config["sandbox"]["path_out"],
    config["sandbox"]["sub_file"],
...
months_confirmed_books.get_months_confirmed_books(
    config["sandbox"]["path_in"],
    config["sandbox"]["path_out"],
